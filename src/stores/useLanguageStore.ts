...
const translations: Record<Language, Translations> = {
  en: {
    ...
    // Progress Tracking
    'progress.weeklyCheckIn': 'Weekly Check-in',
    'progress.week': 'Week',
    'progress.updateMetrics': 'Update Your Metrics',
    'progress.baseline': 'Baseline',
    'progress.target': 'Target',
    'progress.current': 'Current',
    'progress.overallProgress': 'Overall Progress',
    'progress.confidenceLevel': 'Confidence Level',
    'progress.onTrack': 'On Track',
    'progress.atRisk': 'At Risk',
    'progress.offTrack': 'Off Track',
    'progress.notes': 'Notes',
    'progress.optional': 'optional',
    'progress.notesPlaceholder': 'What did you accomplish this week? Any blockers?',
    'progress.saveCheckIn': 'Save Check-in',
    'progress.checkInSuccess': 'Check-in saved successfully',
  ...
  zh: {
    ...
    // Progress Tracking
    'progress.weeklyCheckIn': '周度更新',
    'progress.week': '第',
    'progress.updateMetrics': '更新您的指标数据',
    'progress.baseline': '基准值',
    'progress.target': '目标值',
    'progress.current': '当前值',
    'progress.overallProgress': '整体进度',
    'progress.confidenceLevel': '信心指数',
    'progress.onTrack': '正常',
    'progress.atRisk': '有风险',
    'progress.offTrack': '落后',
    'progress.notes': '备注',
    'progress.optional': '可选',
    'progress.notesPlaceholder': '本周完成了什么？遇到什么阻碍？',
    'progress.saveCheckIn': '保存更新',
    'progress.checkInSuccess': '更新保存成功',
    'progress.trend': '进度趋势',
